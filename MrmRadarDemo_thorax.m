...
Tzero_ns = 14; % This sets the time at which the pulse leaves the tx antenna
Rstart_m = 0;  % This is the distance from the tx antenna at which to start the scan window
Rstop_m = 1;  % This is the distance to end the scan window
...
cfgStruct.pulseIntegrationIndex = uint16(15);
